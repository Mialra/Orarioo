...
(function () {
  ...
  function initCrudModule(config) {
    ...
    const paginationController =
      pagination && pagination.createPaginationController
    ...
    function renderCurrentPage() {
      ...
      const pageItems = useServerPagination
        ...
        : paginationController
          ? paginationController.getPageSlice(sourceItems)
          : sourceItems;
    ...
    function buildListUrl(page) {
      if (typeof config.list.buildPageUrl === "function") {
        return config.list.buildPageUrl(
          page,
          paginationController ? paginationController.pageSize : config.list.pageSize,
        );
      }
    ...
    async function fetchList(requestedPage) {
      ...
      const totalItems =
        response.data && typeof response.data.count === "number" ? response.data.count : pageItems.length;
