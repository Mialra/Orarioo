(function () {
    ...
    const elements = {
        ...
        preferenceBrushInput:
            document.getElementById("admin-teacher-preference-brush") ||
            document.getElementById("teacherPreferenceBrush"),
        ...
        preferencesGridContainer:
            document.getElementById("admin-teacher-preferences-grid") ||
            document.getElementById("teacherPreferencesGrid"),
    ...
    function resetPreferencesGrid(preferences) {
        DAYS.forEach(function (day) {
            HOURS.forEach(function (hour) {
                ...
                const nextState = preferences && PREFERENCE_STATES.indexOf(preferences[slot]) >= 0
                    ? preferences[slot]
                    : "AVAILABLE";
    ...
    admin.createEntityManager({
        ...
        list: {
            ...
            emptyMessage: elements.emptyMessageNode ? elements.emptyMessageNode.textContent.trim() : "No hay profesores registrados.",
        ...
        form: {
            ...
            fields: [
                ...
                },
                {
                    ...
                    required: true,
                    requiredMessage: "El máximo de horas semanales es obligatorio.",
                },
                {
                    name: "working_hours",
            ...
            resetValues: function () {
                ...
                elements.maxWeeklyHoursInput.value = "20";
