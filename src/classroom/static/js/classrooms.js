/**
 * Admin page entrypoint for classroom CRUD management.
 */
(function () {
  ...
  /**
   * Returns the display name for a classroom.
   * Input: classroom - classroom object from the API
   * Output: string display name, defaults to "Aula" if missing
   */
  ...
  /**
   * Renders a single classroom card for the admin list.
   * Input: classroom - classroom object from the API
   * Output: DOM div element representing the classroom card
   */
